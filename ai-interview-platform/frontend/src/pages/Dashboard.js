      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div className="mb-8"
          ...
          <div className="flex items-center gap-3 mb-1">
            <motion.div animate={{ rotate:[0,15,-15,0], scale:[1,1.2,1] }}
              ...
              <Sparkles className="w-7 h-7 text-green-500 dark:text-blue-400" />
            </motion.div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1 ml-10">Ready to practice your interview skills?</p>
        </motion.div>
        ...
        <motion.div className="grid md:grid-cols-2 gap-6 mb-8"
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="group relative p-8 bg-white dark:bg-[#111827] rounded-2xl shadow-lg hover:shadow-2xl transition-all text-left border border-gray-100 dark:border-gray-800 overflow-hidden w-full"
          >
            {/* Animated Background Gradient */}
            <motion.div
              className="absolute inset-0 bg-gradient-to-br from-green-500/5 to-emerald-500/5 dark:from-green-500/10 dark:to-emerald-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              animate={{ 
            ...
            <motion.div
              ...
              className="w-16 h-16 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center mb-5 shadow-lg relative"
            >
              <FileText className="w-8 h-8 text-white" />
            </motion.div>
            <h3 className="relative text-2xl font-bold text-gray-900 dark:text-white mb-3 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">
              Upload Resume
            </h3>
            ...
            >
              <div className="w-10 h-10 bg-green-500/10 dark:bg-green-400/10 rounded-full flex items-center justify-center">
          ...
          >
            {/* Animated Background Gradient */}
            <motion.div
              className="absolute inset-0 bg-gradient-to-br from-pink-500/5 to-orange-500/5 dark:from-pink-500/10 dark:to-orange-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
            ...
            <motion.div
              ...
              className="w-16 h-16 bg-gradient-to-br from-pink-400 via-rose-400 to-orange-400 rounded-2xl flex items-center justify-center mb-5 shadow-lg relative"
            >
              <Play className="w-8 h-8 text-white" />
            </motion.div>
            <h3 className="relative text-2xl font-bold text-gray-900 dark:text-white mb-3 group-hover:text-pink-600 dark:group-hover:text-pink-400 transition-colors">
              Start New Interview
            </h3>
            <p className="relative text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <motion.div className="grid md:grid-cols-4 gap-6 mb-8"
          ...
          {stats.map((stat, index) => (
            ...
            <motion.div
              ...
              className="group relative bg-white dark:bg-[#111827] rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-800 overflow-hidden h-full"
            >
              {/* Animated Background */}
              <motion.div
              ...
              <p className="relative text-gray-600 dark:text-gray-400 text-sm mb-2 font-medium">{stat.label}</p>
              <motion.p 
                className="relative text-3xl font-black text-gray-900 dark:text-white"
        ...
        <motion.div className="mb-8"
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="text-2xl font-black text-gray-900 dark:text-white">Adaptive Progression</h2>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* Interview Tier */}
            <TiltCard>
              <div className="relative bg-white dark:bg-[#111827] rounded-2xl shadow-lg p-5 border border-gray-100 dark:border-gray-800 overflow-hidden h-full">
                <motion.div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-indigo-500/5 dark:from-purple-500/10 dark:to-indigo-500/10"
                  animate={{ opacity: [0.3, 0.6, 0.3] }} transition={{ duration: 3, repeat: Infinity }} />
                <div className="relative">
                  <div className="flex items-center gap-2 mb-3">
                    <Shield className="w-5 h-5 text-purple-500" />
                    <span className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Difficulty Reached</span>
                  </div>
                  <motion.p className="text-2xl font-black text-purple-600 dark:text-purple-400"
            ...
            <TiltCard>
              <div className="relative bg-white dark:bg-[#111827] rounded-2xl shadow-lg p-5 border border-gray-100 dark:border-gray-800 overflow-hidden h-full">
                <motion.div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-teal-500/5 dark:from-emerald-500/10 dark:to-teal-500/10"
                  animate={{ opacity: [0.3, 0.6, 0.3] }} transition={{ duration: 3, repeat: Infinity }} />
                <div className="relative">
                  <div className="flex items-center gap-2 mb-3">
                    <TrendingUp className="w-5 h-5 text-emerald-500" />
                    <span className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Confidence Growth</span>
                  </div>
                  <motion.p className="text-2xl font-black text-emerald-600 dark:text-emerald-400"
                    whileHover={{ scale: 1.05 }}>
            ...
            <TiltCard>
              <div className="relative bg-white dark:bg-[#111827] rounded-2xl shadow-lg p-5 border border-gray-100 dark:border-gray-800 overflow-hidden h-full">
                <motion.div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-cyan-500/5 dark:from-blue-500/10 dark:to-cyan-500/10"
                  animate={{ opacity: [0.3, 0.6, 0.3] }} transition={{ duration: 3, repeat: Infinity }} />
                <div className="relative">
                  <div className="flex items-center gap-2 mb-3">
                    <Award className="w-5 h-5 text-blue-500" />
                    <span className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Best Role</span>
                  </div>
                  <motion.p className="text-2xl font-black text-blue-600 dark:text-blue-400 truncate"
                    whileHover={{ scale: 1.05 }}>
            ...
            <TiltCard>
              <div className="relative bg-white dark:bg-[#111827] rounded-2xl shadow-lg p-5 border border-gray-100 dark:border-gray-800 overflow-hidden h-full">
                <motion.div className="absolute inset-0 bg-gradient-to-br from-red-500/5 to-orange-500/5 dark:from-red-500/10 dark:to-orange-500/10"
                  animate={{ opacity: [0.3, 0.6, 0.3] }} transition={{ duration: 3, repeat: Infinity }} />
                <div className="relative">
                  <div className="flex items-center gap-2 mb-3">
                    <Target className="w-5 h-5 text-red-500" />
                    <span className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Weakest Topic</span>
                  </div>
                  <motion.p className="text-2xl font-black text-red-600 dark:text-red-400 truncate"
                    whileHover={{ scale: 1.05 }}>
          ...
          {((statistics?.weakTopics && statistics.weakTopics.length > 0) || (statistics?.strongTopics && statistics.strongTopics.length > 0)) && (
            <div className="grid md:grid-cols-2 gap-4 mt-4">
              {statistics?.strongTopics && statistics.strongTopics.length > 0 && (
                <div className="bg-white dark:bg-[#111827] rounded-2xl shadow-lg p-5 border border-gray-100 dark:border-gray-800">
                  <div className="flex items-center gap-2 mb-3">
                    <BarChart3 className="w-4 h-4 text-emerald-500" />
                    <span className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Strong Areas</span>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {statistics.strongTopics.map((topic, i) => (
                      <motion.span key={i} whileHover={{ scale: 1.08, y: -2 }}
                        className="px-3 py-1 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 rounded-lg text-xs font-bold">
                        ✓ {topic}
                      </motion.span>
                    ))}
                  </div>
              ...
              {statistics?.weakTopics && statistics.weakTopics.length > 0 && (
                <div className="bg-white dark:bg-[#111827] rounded-2xl shadow-lg p-5 border border-gray-100 dark:border-gray-800">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Areas to Improve</span>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {statistics.weakTopics.map((topic, i) => (
                      <motion.span key={i} whileHover={{ scale: 1.08, y: -2 }}
                        className="px-3 py-1 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded-lg text-xs font-bold">
                        ✗ {topic}
                      </motion.span>
                    ))}
                  </div>
          ...
          {statistics?.trend && statistics.trend.length > 0 && (
            <div className="bg-white dark:bg-[#111827] rounded-2xl shadow-lg p-5 border border-gray-100 dark:border-gray-800 mt-4">
        ...
        <motion.div 
          className="bg-white dark:bg-[#111827] rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-gray-800"
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <motion.div
              ...
              className="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-500 dark:from-blue-500 dark:to-purple-500 rounded-full flex items-center justify-center"
            >
            ...
            <div className="space-y-4">
              {recentInterviews.map((interview, index) => (
                <motion.div
                  ...
                  className="group relative border-2 border-gray-100 dark:border-gray-800 rounded-xl p-6 hover:border-green-300 dark:hover:border-primary-600 transition-all cursor-pointer bg-white dark:from-gray-800 dark:to-gray-900 overflow-hidden card-3d"
                  onClick={() => navigate(`/interview/${interview._id}`)}
                  style={{ transformStyle: 'preserve-3d' }}
                >
                  {/* Animated Background Gradient */}
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-r from-green-500/5 to-emerald-500/5 dark:from-blue-500/5 dark:to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                  ></motion.div>
                  ...
                  <div className="relative flex justify-between items-start">
                    ...
                    <motion.div 
                      ...
                      transition={{ duration: 0.5 }}
                    >
                      <div className="text-4xl font-black bg-gradient-to-r from-green-600 to-emerald-600 dark:from-primary-400 dark:to-blue-400 bg-clip-text text-transparent">
                        {interview.scores?.overall || 'N/A'}
                      </div>
                      <p className="text-xs text-gray-500 dark:text-gray-400 font-semibold">Overall Score</p>
                    </motion.div>
                  </div>

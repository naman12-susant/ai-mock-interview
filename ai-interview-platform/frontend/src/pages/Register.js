  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:from-gray-900 dark:to-black py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-10 right-10 w-64 h-64 bg-yellow-50/10 dark:bg-purple-500/20 rounded-full blur-3xl"
      ></motion.div>
      <motion.div
        animate={{ y: [0, 30, 0], rotate: [360, 180, 0], scale: [1, 1.3, 1] }}
        transition={{ duration: 25, repeat: Infinity }}
        className="absolute bottom-10 left-10 w-80 h-80 bg-green-50/10 dark:bg-blue-500/20 rounded-full blur-3xl"
      ></motion.div>
